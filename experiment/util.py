...
def write_verification_results(organized):
    joblib.dump(organized, "processed_results/verification.joblib")


def load_verification_results():
    return joblib.load("processed_results/verification.joblib")
